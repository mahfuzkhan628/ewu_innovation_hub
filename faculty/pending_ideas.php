    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 main-content">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom border-secondary">
                <div>
                    <h1 class="h2 text-cyan">Pending Student Ideas ⏳</h1>
                    <p class="text-white-50">Review submitted student innovations and provide decision/feedback.</p>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <?php while ($idea = $result->fetch_assoc()): ?>
                        <div class="col-md-6 col-lg-6">
                            <div class="card bg-dark text-white p-4 shadow-sm h-100 d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <h5 class="text-white mb-0"><?php echo htmlspecialchars($idea['title']); ?></h5>
                                    <span class="badge bg-secondary ms-2"><?php echo htmlspecialchars($idea['category']); ?></span>
                                </div>
                                
                                <div class="small text-info mb-3">
                                    👤 By: <?php echo htmlspecialchars($idea['student_name']); ?> (<?php echo htmlspecialchars($idea['student_dept']); ?>)
                                </div>
                                ...
                                <div class="mt-auto pt-3 border-top border-secondary d-flex justify-content-between align-items-center">
                                    <small class="text-white-50">📅 <?php echo date('M d, Y', strtotime($idea['submitted_at'])); ?></small>
                                    <a href="review_idea.php?id=<?php echo $idea['idea_id']; ?>" class="btn btn-sm text-dark fw-bold px-3" style="background-color: #06b6d4;">
                                        Review Idea 🔍
                                    </a>
                                </div>
                            </div>
            ...
            <?php else: ?>
                <div class="card bg-dark text-white p-5 text-center shadow-sm">
                    <h4 class="text-white-50">No Pending Ideas! 🎉</h4>
