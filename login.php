        ...
        <div class="row align-items-center min-vh-100">
            ...
            <div class="col-lg-6 auth-left">
                ...
                <div class="auth-points">
                    <div>💡 Share Innovative Ideas</div>
                    <div>👨‍🏫 Connect With Faculty Mentors</div>
                    <div>🚀 Build Future Solutions</div>
                </div>
            </div>
                    ...
                    <form id="loginForm" action="auth/login_process.php" method="POST">
                        ...
                        <div class="input-group-custom">
                            ...
                            <div class="password-wrapper">
                                <input class="password-field" type="password" name="password" placeholder="Enter your password" required>
